...
export function TrendsInterestChart({
  series,
  chartData,
  loading = false,
  description = 'Índice relativo 0–100 · Google Trends · últimos 30 dias',
  emptyMessage = 'Sem dados de interesse ainda. Rode a coleta do Google Trends.',
}: TrendsInterestChartProps) {
  if (loading) {
    return (
