      ...
      >
        <div className="flex items-start justify-between gap-3 border-b border-card px-4 py-3">
          <div className="min-w-0">
            ...
            >
              <Link2 className="h-4 w-4 text-[#f2d06b]" aria-hidden />
        ...
        <div className="space-y-3 overflow-y-auto px-4 py-3">
          ...
          <div className="rounded-xl border border-card bg-background px-3 py-2.5">
            ...
            <textarea
              ...
              className="mt-2 w-full resize-y rounded-lg border border-card bg-surface px-3 py-2 text-xs text-text-primary outline-none focus:border-[#f2d06b]"
            />
            ...
            <>
              <label className="relative block">
                ...
                <input
                  ...
                  className="h-9 w-full rounded-lg border border-card bg-background pl-8 pr-3 text-xs text-text-primary outline-none focus:border-[#f2d06b]"
                />
              </label>
                      ...
                      <li key={item.id}>
                        <button
                          ...
                          className={cn(
                            ...
                            selected
                              ? 'bg-[#f2d06b]/15 text-text-primary'
                        ...
                        >
                          <span className="flex min-w-0 items-center gap-1.5">
                            {item.isFolder ? (
                              <FolderOpen
                                className="h-3.5 w-3.5 shrink-0 text-[#f2d06b]"
                                aria-hidden
                              />
                            ) : (
                              <FileText
