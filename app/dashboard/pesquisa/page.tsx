  ...
  const seletorCandidatoPadrao = (
    <div className="relative inline-flex max-w-xs items-center">
      <select
        ...
        className="appearance-none rounded-[99px] border border-[rgb(var(--color-border-secondary)/0.85)] bg-transparent py-1 pl-2.5 pr-7 text-[13px] font-medium text-text-primary transition-colors hover:border-[#f04b23] focus:outline-none focus:ring-2 focus:ring-[#f04b23]/25"
      >
                  ...
                  <tr className="border-b border-card">
                    ...
                    <th className="align-top py-3 px-4 text-left text-sm font-semibold text-text-primary">
                      ...
                      <input
                        ...
                        className={cn(
                          'mt-2 w-full min-w-[8rem] max-w-[18rem] rounded-md border px-2 py-1.5 text-xs font-normal text-text-primary placeholder:text-secondary focus:outline-none focus:ring-2 focus:ring-[#f04b23]/40',
                          inputShellClass
                        )}
                        autoComplete="off"
                      />
