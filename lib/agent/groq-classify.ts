...
function buildSystemPrompt(context?: AgentContextPayload): string {
  ...
  return [
    ...
    '- resposta_direta: cumprimentos (oi, bom dia, boa tarde, boa noite, boa tarde jarvis) — resposta curta em direct_reply. Nunca interprete "jarvis" como cidade.',
    '- ajuda: quando pedir ajuda, comandos ou exemplos.',
