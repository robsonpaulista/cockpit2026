...
/** Item ativo no menu quando o tema não é Cockpit (borda esquerda coral). */
export const DEFAULT_THEME_ACTIVE_MENU_ITEM =
  'border-l-2 border-l-[#f04b23] bg-bg-app text-text-primary font-medium shadow-none'

export const DEFAULT_THEME_ACTIVE_CHILD_PILL =
  'border-l-2 border-l-[#f04b23] bg-bg-app text-text-primary font-medium'
