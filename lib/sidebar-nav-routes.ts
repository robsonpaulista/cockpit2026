...
const EXTRA_ALIASES: Record<string, string[]> = {
  ...
  territorio: ['territorio', 'territorio e campo', 'base', 'liderancas territorio', 'campo e agenda', 'campo', 'visitas'],
  agenda: ['agenda google', 'google calendar', 'compromissos', 'cronograma'],
